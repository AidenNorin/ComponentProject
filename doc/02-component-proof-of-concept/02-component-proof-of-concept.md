...
I'm choosing to attempt designing the `Triangle` component design. My reasons
for choosing this design project over the other two designs are:
...
- Designed a proof of concept for `Triangle` component
